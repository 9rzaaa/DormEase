...
Route::post('/login', function () {
    ...
    if ($user->role !== $role) {
        return back()
            ->withErrors([
                'email' => 'Access denied. Invalid role for this account.'
            ])
            ->withInput();
    }
...
Route::middleware('auth:staff')->group(function () {
    ...
    Route::post('/tenants/{id}/reset-password',
        [TenantController::class, 'resetPassword']
    ...
    Route::post('/announcements/{id}/archive',
        [AnnouncementController::class, 'archive']
    )->name('announcements.archive');

    Route::post('/announcements/{id}/restore',
        [AnnouncementController::class, 'restore']
    ...
    Route::post('/visitors/checkout/{id}',
        [VisitorController::class, 'checkout']
