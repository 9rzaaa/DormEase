  ...
  <div class="footer-btm">
    ...
    <div class="footer-btm-right">
      <div class="footer-socials">
        ...
        <a class="footer-social-icon" href="https://www.tiktok.com/@srbdormitory?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
...
<script>
  ...
  (function(){
    ...
    const ANSWERS = [
      ...
      { id: 'curfew', keys: ['curfew','gating time','lock time','gate time','anong oras pasok','uwi','gate close','time in','time out'], answer: "Curfew is strictly at 10:00 PM every night. If you need to stay out beyond curfew hours, you must submit a letter or curfew form to the Admin office in advance to inform them.", follow: ['rules','visitor','security'] },      { id: 'male_visitor', keys: ['male visitor','lalaki','boyfriend','male relative','lalaking bisita','pwede ba ang lalaki','can males visit'], answer: "Male visitors are not allowed inside the units, including male relatives. Only female friends and relatives may visit, subject to the visitor limit and dorm guidelines. They must register at the front desk and leave before curfew.", follow: ['visitor','rules','contact'] },
      ...
      { id: 'furnished', keys: ['furnished','furniture included','semi-furnished','kasama na ba','what furniture','bed included','may bed','may lamesa','desk included','wardrobe included','inclusion','exclusion','what comes with the room'], answer: "Rooms are semi-furnished. Included with the room:\n\nBed\nWardrobe or cabinet\nStudy table\nBookshelf\n\nNot included (tenants must bring or provide their own):\n\nAircon unit\nRefrigerator, electric fan, and other appliances\n\nFor Wi-Fi, you may self-connect your own internet line, or use the dorm connection at 300 pesos per device per month.", follow: ['wifi','aircon','furniture'] },      { id: 'greeting', keys: ['hi','hello','hey','good morning','good afternoon','good evening','kumusta','kamusta','musta','magandang umaga','magandang hapon','magandang gabi'], answer: "Hi there! Welcome to Sanctissimo Rosario Ladies Dormitory. I'm here to help you with anything about our rooms, amenities, rules, and more.\n\nWhat would you like to know?", follow: ['roomtypes','price','location'] },
      ...
      { id: 'reservation', keys: ['reservation fee','deposit','advance','reserve fee','down payment','paunang bayad','reservation deposit','how much to reserve'], answer: "To reserve a room, a 1-month advance payment is required. This secures your slot once it is approved by the admin team. Contact us at +63 917 535 9723 to get started.", follow: ['apply','price','contact'] },
      { id: 'contract_start', keys: ['contract start','when can i move in','start date','move in date','kailan pwede mag move in','academic year start','school year start','can i start anytime'], answer: "Contracts usually start in August, but you can move in at any time as long as a room is available. Reach out to our admin team to check current openings and availability.", follow: ['apply','price','reservation'] },
      { id: 'studyhub', keys: ['study hub','coffee shop','cafe','study spot','place to study','study place','kape','kapehan','study area nearby'], answer: "There are several options nearby. Cotti Coffee is right downstairs from the dorm, making it the closest and most convenient option. Coffee Pages is also a popular spot in the area, along with Uncle John's Convenience Store for quick snacks and drinks. All are very accessible on foot.", follow: ['near','transport','location'] },
    ...
    const SUGGESTION_MAP = {
      solo:          { icon: '', text: 'Solo rooms' },
      double:        { icon: '', text: 'Double rooms' },
      triple:        { icon: '', text: 'Triple rooms' },
      quad:          { icon: '', text: 'Quad rooms' },
      ...
      garbage:       { icon: '', text: 'Garbage disposal' },
      laundry:       { icon: '', text: 'Laundry policy' },
      ironing:       { icon: '', text: 'Flat iron policy' },
      ...
      barangay:      { icon: '', text: 'Barangay Hall' },
      furniture:     { icon: '', text: 'Bring furniture' },
      ...
      furnished:     { icon: '', text: 'Furniture included' },
      about:         { icon: '', text: 'About the dorm' },
