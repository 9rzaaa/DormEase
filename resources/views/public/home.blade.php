...
.hero-badge::before {
  content: ''; width: 6px; height: 6px; background: var(--pink);
  border-radius: 50%; animation: pulse 2s infinite; flex-shrink: 0;
}
@keyframes pulse { 0%,100%{opacity:1;transform:scale(1)} 50%{opacity:.4;transform:scale(.7)} }

.hero h1 { font-family: var(--font-head); font-size: clamp(2.8rem,4.5vw,4.2rem); font-weight: 800; line-height: 1.08; color: var(--brown); margin-bottom: 22px; letter-spacing: -0.03em; }
.hero h1 em { font-style: italic; color: var(--pink); font-weight: 700; }
.hero-sub { font-size: 0.97rem; color: var(--brown-light); line-height: 1.85; max-width: 420px; margin-bottom: 36px; }
...
.hero-chips { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 32px; padding-top: 28px; border-top: 1px solid var(--border); }
.hero-chip {
  ...
  font-size: 0.80rem; font-weight: 600; color: var(--brown); font-family: var(--font-body);
  transition: border-color 0.2s, color 0.2s, background 0.2s;
}
.hero-chip:hover { border-color: var(--pink-light); background: var(--pink-pale); color: var(--pink-deep); }
.hero-chip-dot { width: 7px; height: 7px; background: var(--pink-light); border-radius: 50%; flex-shrink: 0; }

.hero-arch-wrap {
  position: relative; display: flex; justify-content: center; align-items: center;
  height: 100%; min-height: 100svh; z-index: 1;
}
.hero-blob-top { position: absolute; top: 12%; right: 4%; width: 220px; height: 200px; background: var(--pink-light); border-radius: 60% 80% 40% 70% / 50% 60% 80% 40%; opacity: 0.40; z-index: 0; }
.hero-blob-bottom { position: absolute; bottom: 14%; left: 2%; width: 160px; height: 150px; background: var(--pink-pale); border-radius: 70% 40% 60% 50% / 60% 80% 40% 70%; opacity: 0.75; z-index: 0; }
.hero-arch { position: relative; z-index: 1; width: 380px; height: 520px; border-radius: 220px 220px 36px 36px; overflow: hidden; box-shadow: 0 40px 90px rgba(58,32,16,0.16), 0 0 0 10px rgba(214,56,104,0.07); }
...
.gal-img { width:100%; height:100%; object-fit:cover; object-position:center; display:block; transition:transform .4s; }
...
<section class="gallery" id="gallery">
  ...
  <div class="gallery-grid reveal">
    <div class="gal-item">
      <div class="gal-img-wrap"><img src="{{ asset('images/solo.jpg') }}" alt="Solo Room" class="gal-img"></div>
      <div class="gal-label">
    ...
    <div class="gal-item">
      <div class="gal-img-wrap"><img src="{{ asset('images/two.jpg') }}" alt="Double Room" class="gal-img"></div>
      <div class="gal-label">
    ...
    <div class="gal-item">
      <div class="gal-img-wrap"><img src="{{ asset('images/three.jpg') }}" alt="Triple Room" class="gal-img"></div>
      <div class="gal-label">
    ...
    <div class="gal-item">
      <div class="gal-img-wrap"><img src="{{ asset('images/four.jpg') }}" alt="Quad Room" class="gal-img"></div>
      <div class="gal-label">
      ...
      <div class="de-mockup-wrap">
        ...
        <div class="de-phone center">
          ...
          <div class="de-screen">
            ...
            <div class="de-bill-card"><div class="de-bill-label">Current Water Bill</div><div class="de-bill-amount">₱ 320.00</div></div>
        ...
        <div class="de-phone side">
          ...
          <div class="de-screen">
            ...
            <div class="de-notices">
              <div class="de-notice-item"><div class="de-notice-title">Water Interruption</div><div class="de-notice-body">No water supply on June 10, 8AM–12NN for maintenance.</div><div class="de-notice-date">Jun 9, 2026</div></div>
...
<section class="cta-section" id="contact">
  <div class="contact-inner reveal">
    <div class="contact-copy">
      ...
      <div class="cta-contact">1229 Navarra Street, Sampaloc, Manila &nbsp;·&nbsp; Near UST &amp; University Belt</div>
    </div>
