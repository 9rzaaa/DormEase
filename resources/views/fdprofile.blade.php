...
<style>
    ...
    .identity-name { font-size: .98rem; font-weight: 700; color: var(--ink); line-height: 1.2; }
    .identity-email { font-size: .75rem; color: var(--ink-muted); margin-top: .15rem; }
    .identity-chips { display: flex; flex-wrap: wrap; gap: .35rem; margin-top: .4rem; }
    ...
    .meta-pill-val.normal { font-family: var(--ff-body); color: var(--ink); }
    ...
    .section-body form { flex: 1; display: flex; flex-direction: column; }
    .form-fields { flex: 1; }
    ...
    .form-field input {
        ...
        color: var(--ink); background: var(--pink-bg);
        outline: none; transition: border-color .2s, background .2s; width: 100%;
    }
    .form-field input:focus {
        border-color: var(--hot-pink); background: var(--white);
    ...
    .pw-strength-bar { height: 3px; border-radius: 2px; background: var(--pink-100); overflow: hidden; }
    ...
    .btn-cancel {
        ...
        border: 1.5px solid var(--pink-light); background: none;
...
<div class="modal-overlay" id="deactivate-modal">
    <div class="modal" style="max-width:380px;">
        ...
        <form method="POST" action="{{ route('frontdesk.profile.deactivate') }}">
            @csrf
            @method('PUT')
