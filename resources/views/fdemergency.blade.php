...
<div class="page-body">
    ...
    <div class="stats-row fade-up d2">
        ...
        <div class="stat-card">
            <div class="stat-icon">
                <img src="{{ asset('icons/warn.png') }}" alt="Active">
            </div>
            <div>
        ...
        <div class="stat-card">
            <div class="stat-icon">
                <img src="{{ asset('icons/panic.png') }}" alt="Panic">
            </div>
            <div>
...
<script>
    ...
    function viewReport(r) {
        ...
        document.getElementById('view-content').innerHTML = `
            ...
            <div class="view-detail-row">
                <div class="view-detail-label">Tenant / Reporter</div>
                <div class="view-detail-val">${escHtml(r.tenant_name)} — Room ${escHtml(String(r.room_number))}</div>
            </div>
            <div class="view-detail-row">
